...
export const COMPONENT_TOKENS: Record<string, TokenEntry[]> = {
  ...
  'radio': [
    { category: 'Background', name: 'checked fill',          cssVar: '--color-bg-brand-primary', value: t => t.color.bg.brand.primary },
    { category: 'Background', name: 'unchecked bg',          value: _ => '#FFFFFF' },
    { category: 'Background', name: 'disabled unchecked',    value: _ => '#FFFFFF' },
    { category: 'Background', name: 'disabled checked fill', value: _ => '#D1D5DB' },
    { category: 'Border',     name: 'default',               value: _ => '#D1D5DB' },
    { category: 'Border',     name: 'hover',                 value: _ => '#9CA3AF' },
    { category: 'Border',     name: 'focus / selected',      cssVar: '--color-border-brand', value: t => t.color.border.brand },
    { category: 'Border',     name: 'error',                 value: _ => '#EF4444' },
    { category: 'Border',     name: 'disabled',              value: _ => '#E5E7EB' },
    { category: 'Shadow',     name: 'focus ring (default)',  value: _ => '0 0 0 3px rgba(29,50,255,0.18)' },
    { category: 'Shadow',     name: 'focus ring (error)',    value: _ => '0 0 0 3px rgba(239,68,68,0.18)' },
    { category: 'Text',       name: 'label enabled',         value: _ => '#374151' },
    { category: 'Text',       name: 'label error',           value: _ => '#EF4444' },
    { category: 'Text',       name: 'label disabled',        value: _ => '#A3A3A3' },
    { category: 'Text',       name: 'inner dot (enabled)',   value: _ => '#FFFFFF' },
    { category: 'Text',       name: 'inner dot (disabled)',  value: _ => '#9CA3AF' },
    { category: 'Size',       name: 'xs circle',             description: '16×16px', value: _ => '16px', isNumeric: true },
    { category: 'Size',       name: 'xs dot',                description: '6×6px',   value: _ => '6px',  isNumeric: true },
    { category: 'Size',       name: 'sm circle',             description: '20×20px', value: _ => '20px', isNumeric: true },
    { category: 'Size',       name: 'sm dot',                description: '8×8px',   value: _ => '8px',  isNumeric: true },
  ],

  'progress-bar': [
    { category: 'Background', name: 'track (empty)',         value: _ => '#E5E7EB' },
    { category: 'Background', name: 'fill — loading',        cssVar: '--color-bg-brand-primary', value: t => t.color.bg.brand.primary },
    { category: 'Background', name: 'fill — fail',           value: _ => '#EF4444' },
    { category: 'Background', name: 'fill — complete',       value: _ => '#16A34A' },
    { category: 'Text',       name: 'label',                 value: _ => '#374151' },
    { category: 'Text',       name: 'required asterisk',     value: _ => '#EF4444' },
    { category: 'Text',       name: 'progress text',         value: _ => '#9CA3AF' },
    { category: 'Radius',     name: 'track / fill (pill)',   description: '999px', value: _ => '999px', isNumeric: true },
    { category: 'Size',       name: 'track height — sm',     description: '2px',   value: _ => '2px',  isNumeric: true },
    { category: 'Size',       name: 'track height — md',     description: '8px',   value: _ => '8px',  isNumeric: true },
  ],

  'date-picker': [
    { category: 'Background', name: 'input bg',                value: _ => '#FFFFFF' },
    { category: 'Background', name: 'input disabled bg',       value: _ => '#F5F5F5' },
    { category: 'Background', name: 'calendar surface',        value: _ => '#FFFFFF' },
    { category: 'Background', name: 'day — today outline bg',  value: _ => 'transparent' },
    { category: 'Background', name: 'day — selected fill',     cssVar: '--color-bg-brand-primary', value: t => t.color.bg.brand.primary },
    { category: 'Background', name: 'day — in-range bg',       value: _ => '#EEF1FF' },
    { category: 'Background', name: 'day — hover bg',          value: _ => '#F3F4F6' },
    { category: 'Background', name: 'preset chip bg',          value: _ => '#F3F4F6' },
    { category: 'Background', name: 'preset chip active bg',   cssVar: '--color-bg-brand-primary', value: t => t.color.bg.brand.primary },
    { category: 'Border',     name: 'input default',           value: _ => '#D1D5DB' },
    { category: 'Border',     name: 'input focus',             cssVar: '--color-border-brand', value: t => t.color.border.brand },
    { category: 'Border',     name: 'input error',             value: _ => '#EF4444' },
    { category: 'Border',     name: 'input disabled',          value: _ => '#E5E7EB' },
    { category: 'Border',     name: 'calendar card',           value: _ => '#E5E7EB' },
    { category: 'Border',     name: 'today day outline',       cssVar: '--color-border-brand', value: t => t.color.border.brand },
    { category: 'Shadow',     name: 'input focus ring',        value: _ => '0 0 0 3px rgba(29,50,255,0.10)' },
    { category: 'Shadow',     name: 'calendar card',           value: _ => '0 4px 16px rgba(0,0,0,0.10)' },
    { category: 'Text',       name: 'input value',             value: _ => '#171717' },
    { category: 'Text',       name: 'input placeholder',       value: _ => '#9CA3AF' },
    { category: 'Text',       name: 'label',                   value: _ => '#171717' },
    { category: 'Text',       name: 'day — default',           value: _ => '#374151' },
    { category: 'Text',       name: 'day — selected',          value: _ => '#FFFFFF' },
    { category: 'Text',       name: 'day — disabled',          value: _ => '#D1D5DB' },
    { category: 'Text',       name: 'day — today (outlined)',  cssVar: '--color-text-brand', value: t => t.color.text.brand },
    { category: 'Text',       name: 'month/year header',       value: _ => '#111827' },
    { category: 'Text',       name: 'weekday header',          value: _ => '#9CA3AF' },
    { category: 'Text',       name: 'preset chip default',     value: _ => '#374151' },
    { category: 'Text',       name: 'preset chip active',      value: _ => '#FFFFFF' },
    { category: 'Radius',     name: 'input field',             description: '8px',   value: _ => '8px',  isNumeric: true },
    { category: 'Radius',     name: 'calendar card',           description: '14px',  value: _ => '14px', isNumeric: true },
    { category: 'Radius',     name: 'day cell (selected)',      description: '50%',   value: _ => '50%',  isNumeric: true },
    { category: 'Radius',     name: 'preset chip',             description: '999px', value: _ => '999px', isNumeric: true },
  ],
};
