...
const COLORS: Record<"default" | "hover" | "pressed" | "disabled", StateColors> = {
  default: {
    bg:          "#FFFFFF",
    border:      "var(--color-bg-brand-primary, #628AFF)",
    text:        "var(--color-text-brand, #1D32FF)",
    iconColor:   "var(--color-text-brand, #1D32FF)",
    removeBg:    "var(--color-bg-brand-primary, #1D32FF)",
    removeX:     "#FFFFFF",
  },
  hover: {
    bg:          "var(--color-bg-brand-contrast, #EEF1FF)",
    border:      "var(--color-bg-brand-primary, #1D32FF)",
    text:        "var(--color-text-brand, #1D32FF)",
    iconColor:   "var(--color-text-brand, #1D32FF)",
    removeBg:    "var(--color-bg-brand-primary, #1D32FF)",
    removeX:     "#FFFFFF",
