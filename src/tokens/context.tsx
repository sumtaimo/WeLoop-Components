...
export function applyThemeToCSSVars(tokens: ThemeTokens, root: HTMLElement = document.documentElement): void {
  ...
  const vars: Record<string, string> = {
    ...
    '--shadow-brand-hover':     tokens.shadow.brand.hover,
    '--shadow-brand-pressed':   tokens.shadow.brand.pressed,
    '--shadow-brand-secondary': tokens.shadow.brand.secondary,
    '--shadow-brand-sm':        tokens.shadow.brand.sm,
    '--shadow-brand-md':        tokens.shadow.brand.md,
    '--shadow-default-default': tokens.shadow.default.default,
    '--shadow-default-hover':   tokens.shadow.default.hover,
    '--shadow-default-pressed': tokens.shadow.default.pressed,
    '--shadow-danger-default':  tokens.shadow.danger.default,
    '--shadow-danger-hover':    tokens.shadow.danger.hover,
    '--shadow-danger-pressed':  tokens.shadow.danger.pressed,
    '--shadow-toggle-default':  tokens.shadow.toggle.default,
    '--shadow-toggle-hover':    tokens.shadow.toggle.hover,
    '--shadow-toggle-pressed':  tokens.shadow.toggle.pressed,
    '--shadow-toggle-checked':  tokens.shadow.toggle.checked,
    '--shadow-input-default':   tokens.shadow.input.default,
    '--shadow-input-brand':     tokens.shadow.input.brand,
    '--shadow-input-warning':   tokens.shadow.input.warning,
    '--shadow-input-success':   tokens.shadow.input.success,
    '--shadow-disabled':        tokens.shadow.disabled,
